...
def preproceed_data(data_path , output_path, n_fft, n_mels, hop_length , save = False, verbose = 0):
...
def main(args):
    preproceed_data(args.data_path, args.output_path, args.n_fft, args.n_mels, args.hop_length , save=True, verbose=2)
